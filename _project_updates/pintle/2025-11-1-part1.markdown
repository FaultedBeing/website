...
> <span style="font-size: 70%;"> The [Wikipedia page]([Discharge coefficient - Wikipedia](https://en.wikipedia.org/wiki/Discharge_coefficient)) for the equation above</span>
